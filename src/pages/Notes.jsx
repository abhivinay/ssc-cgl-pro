  ...
  return (
    <div className="page">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold">Notes Vault</h1>
      ...
      <div className="card mt-6">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-[240px_1fr_auto]">
          ...
          <textarea
            ...
            aria-label="Write an important point, shortcut or formula..."
          />
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <input
          ...
          aria-label="Search notes or topics..."
        />
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="rounded-lg bg-zinc-800 px-3 py-1 text-xs font-semibold uppercase">
                      {note.subject}
                    </span>
                    {note.pinned && (
                      <span className="rounded-lg bg-cyan-300/10 px-3 py-1 text-xs font-semibold text-cyan-200">
                        Pinned
                      </span>
                    )}
                  </div>
                ...
                <button
                  onClick={() =>
                    updateNote(note.topicId, note.id, { pinned: !note.pinned })
                  }
              ...
              <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-zinc-800 pt-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-cyan-300/40 px-3 py-2 text-sm text-cyan-200"
                  >
                    Delete
                  </button>
                </div>
