      ...
      <div className="mx-auto max-w-7xl pb-10">
        <div className="mb-6">
          ...
          <p className="mt-2 text-zinc-400">
            Stay focused with Pomodoro and Deep Focus sessions.
          </p>
        </div>
        <div className="grid gap-6 lg:grid-cols-[420px_1fr]">
          ...
          <section className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
            ...
            <p className="mt-2 text-zinc-400">
              Complete focus sessions to gain XP and maintain your streak.
            </p>
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-950 p-5">
                ...
                <p className="mt-2 text-2xl font-bold text-white">
                  {TIMER_PRESETS[selectedPreset].minutes} Minutes
                </p>
              </div>
              <div className="rounded-lg border border-zinc-800 bg-zinc-950 p-5">
                <p className="text-sm text-zinc-500">Status</p>
                <p
                  className={`mt-2 text-xl font-bold ${timer.completed ? "text-cyan-200" : timer.running ? "text-cyan-400" : "text-zinc-300"}`}
                >
                  {timer.completed
                    ? "Completed"
                    : timer.running
            ...
            {message && (
              <div className="mt-6 rounded-lg border border-cyan-300/30 bg-cyan-300/10 p-4 text-center font-semibold text-cyan-200">
                {message}
              </div>
            )}
          </section>
