...
export default function MockImport() {
  ...
  const getAIReport = (mock) =>
    mentorEngine({
      progress: studyState.topics.length
        ? (studyState.topics.filter((t) => t.completed).length /
            studyState.topics.length) *
          100
        : 0,
    ...
    <div className="page">
      ...
      <div className="card">
        ...
        <input
          ...
          aria-label="Time Taken (e.g. 56m 20s)"
        />
        ...
        <textarea
          ...
          aria-label="Weak Topics (comma separated)"
        />
        ...
        <textarea
          ...
          aria-label="Strong Topics (comma separated)"
        />
            ...
            {studyState.mocks.map((mock) => {
              ...
              return (
                <div key={mock.id} className="focus-box">
                  ...
                  >
                    <p>
                      <strong>Mode:</strong> {ai.mode}
                    </p>
                    <p>
                      <strong>Priority:</strong> {ai.priority}
                    </p>
                    <p>
                      <strong>Risk:</strong> {ai.risk}
                    </p>
