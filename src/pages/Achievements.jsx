...
export default function Achievements() {
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      revisionsCompleted: revisions.filter((revision) => revision.completed)
        .length,
  ...
  const { achievements, unlockedCount, total, completion } =
  ...
  return (
    <div className="mx-auto max-w-7xl pb-10">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Achievements</h1>

        <p className="mt-2 text-zinc-400">
          Complete milestones, unlock badges and track your SSC Sentinel
          journey.
        </p>
      </div>
      ...
      <div className="mt-6 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
          ...
          <p className="mt-2 text-sm text-zinc-500">Achievements completed</p>
        </div>
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
          ...
          <p className="mt-2 text-sm text-zinc-500">Achievements remaining</p>
        </div>

        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
          <p className="text-sm text-zinc-500">Completion</p>

          <p className="mt-3 text-3xl font-bold text-cyan-200">{completion}%</p>

          <p className="mt-2 text-sm text-zinc-500">Overall badge progress</p>
        </div>

        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
          <p className="text-sm text-zinc-500">Current Level</p>

          <p className="mt-3 text-3xl font-bold text-cyan-200">{level}</p>
