...
return{
difficulty,
challenge:generateSymbolSequence({
difficulty
}),
phase:"memorize",
round:1,
...
export function submitSymbolAnswer(
state,
submittedSequence
){
const validation=validateSymbolSequence(
...
export function createNextSymbolRound(
state
){
return{
...state,
...
export function completeSymbolGame(
state
){
return{
...state,
