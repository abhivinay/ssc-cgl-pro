...
const topicTest = {
  title: "Average Topic Test",
  description: "Complete Average topic covering basic, moderate and advanced SSC CGL patterns.",
  timeLimitMinutes: 30,
  totalQuestions: 25,
  totalMarks: 50,
  marksPerCorrect: 2,
  ...
  ].map((question, index) => ({ ...question, id: `AVG-TT-${String(index + 1).padStart(3, "0")}` })),
  scoreBands: [
