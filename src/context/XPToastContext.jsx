  ...
  return (
    <XPToastContext.Provider value={{ showXPToast }}>
      ...
      {toast && (
        <div
          role="status"
          className="fixed right-5 top-5 z-[100] min-w-56  rounded-lg border border-cyan-300/30 bg-zinc-900/95 p-4  "
        >
          <p className="text-lg font-bold text-cyan-200">+{toast.amount} XP</p>
