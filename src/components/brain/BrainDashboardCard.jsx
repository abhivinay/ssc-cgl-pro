    ...
    <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <div
          className={`flex h-14 w-14 items-center justify-center rounded-lg text-3xl ${
            completed ? "bg-cyan-300/10" : "bg-cyan-300/10"
          }`}
        >
          {completed ? "" : ""}
        </div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-4">
        <div className="rounded-lg bg-zinc-950 p-4">
          ...
          <p className="mt-2 text-2xl font-bold">{safeNumber(score)}</p>
        </div>
      ...
      <div className="mt-5 h-2 overflow-hidden rounded-lg bg-zinc-800">
        <div
      ...
      <button
        type="button"
        onClick={() => onOpen?.()}
        className="mt-5 w-full rounded-lg bg-cyan-900 px-5 py-3 font-semibold transition hover:bg-cyan-900"
      >
