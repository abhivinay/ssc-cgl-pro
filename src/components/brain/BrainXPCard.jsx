    ...
    <div className="rounded-lg border border-cyan-300/20 bg-cyan-300/10 p-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-bold">+{earned} XP</h2>
      ...
      <div className="mt-6 flex items-center justify-between text-sm">
        <span className="text-zinc-500">{current} XP</span>

        <span className="font-semibold text-zinc-300">{target} XP</span>
      </div>

      <div className="mt-3 h-3 overflow-hidden rounded-lg bg-zinc-800">
        <div
