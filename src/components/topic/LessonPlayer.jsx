...
export default function LessonPlayer({ lesson, onComplete, onExit }) {
  ...
  const lessonStats = useMemo(
    () => ({
      accuracy: 100,
      xpEarned: Math.max(0, Number(lesson?.xpReward) || 0),
      cardsCompleted: cards.length,
      totalCards: cards.length,
      timeSpentSeconds,
    }),
    [cards.length, lesson?.xpReward, timeSpentSeconds],
  );
  ...
  return (
    <>
      <div className="space-y-6">
        ...
        <LessonCard card={currentCard} onOpenVisual={setSelectedVisual} />
          ...
          <div className="mx-auto max-w-6xl overflow-hidden rounded-lg border border-white/10 bg-zinc-950">
            ...
            <div className="bg-black p-4 md:p-5">
              <img
                ...
                alt={
                  selectedVisual.alt || selectedVisual.title || "Lesson visual"
                }
