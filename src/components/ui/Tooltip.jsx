  ...
  return (
    ...
    >
      ...
      {visible && content && (
        <span
          role="tooltip"
          className={`pointer-events-none absolute z-[150] whitespace-nowrap rounded-xl border border-white/10 bg-zinc-950 px-3 py-2 text-xs font-semibold text-zinc-200  ${
