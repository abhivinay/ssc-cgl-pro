...
export default function PyqContent({
  ...
  const questions = getSafeQuestions(getStageQuestions, content);

  const topicName = topic?.name || topic?.topic || "Selected Topic";
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-lg border border-cyan-300/20 bg-cyan-300/10 p-5">
        ...
        <h2 className="mt-3 text-3xl font-bold">{topicName} PYQ section</h2>
