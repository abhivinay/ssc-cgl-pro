  ...
  return (
    <div className="space-y-6">
      <section className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
        ...
        <p className="mt-3 leading-7 text-zinc-300">{overview}</p>
      </section>
          ...
          {objectives.length ? (
            objectives.map((item, index) => (
              <div
                ...
                className="flex gap-3 rounded-lg bg-zinc-950 p-4"
              >
                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-cyan-300/10 text-sm text-cyan-200">
                  {index + 1}
                </span>
      ...
      <section className="space-y-4">
        ...
        {concepts.length ? (
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-cyan-300/10 font-bold text-cyan-200">
                    {index + 1}
                  </span>
          ...
          <div className="rounded-lg border border-dashed border-zinc-800 bg-zinc-900/50 p-6">
      ...
      <section className="grid gap-5 lg:grid-cols-2">
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
          <h2 className="text-xl font-bold">Step-by-step method</h2>

          <div className="mt-5 space-y-3">
            {method.length ? (
              method.map((item, index) => (
                <div key={`${String(item)}-${index}`} className="flex gap-3">
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
          <h2 className="text-xl font-bold">Common patterns</h2>
      ...
      <section className="grid gap-5 lg:grid-cols-2">
        <div className="rounded-lg border border-cyan-300/20 bg-cyan-300/10 p-6">
          <h2 className="text-xl font-bold text-cyan-200">SSC shortcuts</h2>
        ...
        <div className="rounded-lg border border-cyan-300/20 bg-cyan-300/10 p-6">
          <h2 className="text-xl font-bold text-cyan-200">Common mistakes</h2>
