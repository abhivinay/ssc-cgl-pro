    ...
    <section className="rounded-lg border border-zinc-800 bg-zinc-900 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          {!isRunning && pending > 0 && processed === 0 && (
            <button
              ...
              onClick={onStart}
              disabled={!total}
              className="rounded-lg bg-cyan-900 px-4 py-2 text-sm font-semibold text-white hover:bg-cyan-900 disabled:cursor-not-allowed disabled:opacity-40"
            >
              Start
            </button>
          )}
      ...
      <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-6">
        ...
        <div className="rounded-xl bg-zinc-950 p-4">
          ...
          <p className="mt-1 text-xl font-bold text-cyan-200">{completed}</p>
        </div>

        <div className="rounded-xl bg-zinc-950 p-4">
          <p className="text-xs text-zinc-500">Failed</p>
          <p className="mt-1 text-xl font-bold text-cyan-200">{failed}</p>
        </div>

        <div className="rounded-xl bg-zinc-950 p-4">
          <p className="text-xs text-zinc-500">Extracting</p>
          <p className="mt-1 text-xl font-bold text-cyan-200">{extracting}</p>
        </div>

        <div className="rounded-xl bg-zinc-950 p-4">
          <p className="text-xs text-zinc-500">Pending</p>
          <p className="mt-1 text-xl font-bold text-cyan-200">{pending}</p>
        </div>
