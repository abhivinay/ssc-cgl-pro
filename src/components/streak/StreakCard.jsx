import {
  getStreakStatus,
  isStreakActive,
} from "../../engine/streak/streakEngine";
    ...
    <section className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p
            className={`mt-2 text-sm font-semibold ${active ? "text-cyan-200" : "text-zinc-500"}`}
          >
            {statusText[status]}
          </p>
        </div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-3">
        ...
        <div className="rounded-lg bg-zinc-950 p-4">
          ...
          <p className="mt-2 text-2xl font-bold text-cyan-200">{bestStreak}</p>
        </div>
      </div>
